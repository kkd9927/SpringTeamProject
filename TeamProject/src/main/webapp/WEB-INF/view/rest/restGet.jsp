        ...
        <div class="container-md">
            <div class="restaurant-box">
                <div class="titleimg-box">
                    <img src="no-photo.png" class="img-fluid">
                </div>
...
<!--                     <h2>가게이름</h2> -->
                ...
                <div class="menu-box">
                    ...
                    <div class="menucat-box d-grid">
                        ...
                        <label class="btn btn-light rounded-0 fw-bold fs-5" for="btncheck1">카테고리명</label>   
                        ...
                        <div class="menulist-box d-grid">
                            ...
                            -->
                            <button class="menuitem-box p-1 bg-white border-0" id="1">
                                    ...
                                    <div class="row g-0">
                                        ...
                                        <div class="col-10">
                                            <div class="card-body">
                                                ...
                                                <p class="card-text">메뉴설명(2줄까지)</p> 
                                                <div class="menuprice-box">
                                                    <p class="card-text fw-bold">가격</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="row g-0">
                                <div class="col-2">
                                    <div class="image-box position-relative">
                                        <img src="no-photo.png" class="img-fluid rounded-start"></button>
