	                ...
	                <div class="col-12">
	                    <div class="card bg-light mb-4">
	                        <div class="card-body">
	                            ...
	                            <div class="pb-3">
	                                <button type="button" onclick="addCat()" id="cat-add" class="btn btn-primary">분류추가</button>
	                            </div>
	
	                            <div class="card">
	                                <div id="templist" class="card-body p-0">
	                                    <!-- 분류명 템플릿 -->
...
<!-- 		                                            </span> -->
	...
	<script type="text/javascript">
		function addCat(){
			var tl = document.getElementById('templist');
