...
//	@Test
	public void testGetOpen() {
		log.info(service.getOpen(14L, 1L));
	}
...
//	@Test
	public void testUpdate() throws Exception {
		...
		Date dateC1 = sdate.parse("22:00");
		RestOpenDTO restOpen1 = service.getOpen(14L, 1L);
		RestOpenDTO restOpen2 = service.getOpen(14L, 2L);
		ArrayList<RestOpenDTO> roDTOList = new ArrayList<>();
